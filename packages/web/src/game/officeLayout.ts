...
export const PLAYER_START = { x: 416, y: 272 } as const;
export const PLAYER_BOUNDS = { minX: 112, maxX: 736, minY: 64, maxY: 448 } as const;
...
export const officeRooms = [
  ...
  { id: "meeting-right", x: 448, y: 64, width: 288, height: 96, texture: "floor-passage" },
  {
  ...
  { id: "lounge", x: 448, y: 176, width: 288, height: 128, texture: "floor-lounge" },
  { id: "future", x: 448, y: 320, width: 288, height: 128, texture: "floor-work" }
] as const;
...
export const officeWalls: readonly Rectangle[] = [
  { x: 96, y: 48, width: 656, height: 16 },
  { x: 96, y: 448, width: 656, height: 16 },
  { x: 96, y: 48, width: 16, height: 416 },
  { x: 736, y: 48, width: 16, height: 416 },
  ...
  { x: 704, y: 160, width: 48, height: 16 },
  { x: 448, y: 304, width: 304, height: 16 },
...
export const officeProps = [
  ...
  { id: "whiteboard", texture: "whiteboard", x: 672, y: 96, width: 64, height: 48, solid: true },
  {
    id: "lounge-plant",
    texture: "plant-small",
    x: 704,
...
export function isLoungePoint(point: Point): boolean {
  return point.x >= 448 && point.x <= 736 && point.y >= 176 && point.y <= 304;
}
