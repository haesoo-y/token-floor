...
export const officeRooms = [
  ...
  { id: "future", x: 112, y: 320, width: 288, height: 128, texture: "floor-work" },
  ...
  { id: "executive-codex", x: 416, y: 320, width: 128, height: 128, texture: "floor-work" },
  { id: "executive-claude", x: 544, y: 320, width: 128, height: 128, texture: "floor-work" }
] as const;
...
export const officeLabels = [
  ...
  { roomId: "executive-codex", x: 424, y: 328, text: "CODEX", color: 0x60a5fa },
  { roomId: "executive-claude", x: 560, y: 328, text: "CLAUDE", color: 0xfb923c }
] as const;
...
export const officeWalls: readonly Rectangle[] = [
  ...
  { x: 536, y: 304, width: 16, height: 160 }
] as const;
